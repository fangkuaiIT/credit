...
public class HTTP {
     ...
     */
    // not used
    // public static int UNPROCESSABLE_ENTITY = 418;
     ...
     * <p>
     * <p>The HTTP status code series can be retrieved via
     *
    ...
    public enum Status {
         ...
         */
        public static HTTP.Status valueOf(int statusCode) {
            for (HTTP.Status status : values()) {
